#ifndef FINALPROJECT_GENERAL_FUNCTIONS_H
#define FINALPROJECT_GENERAL_FUNCTIONS_H
...
/* check if num_str contain a number if it is the succeeded will be 1. otherwise succeeded will be 0.*/
